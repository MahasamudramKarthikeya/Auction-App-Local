...
import Auction1 from "../images/auction1.gif";
...
// console.log(productCount);
  return (
    <>{loading ? (<Loader/>) :(
    <>
    <MetaData title="Auction App"></MetaData>
...
minimum price, end time of bidding, payment method, images of product</p>
            <p><a href="./addlot" className="btn btn-primary">Get Started</a></p>
          </div>
...
he/she will make a bid of that product, valid identity proof</p>
            <p><a href="./lot" className="btn btn-primary">Get Started</a></p>
          </div>
          <div className="col-md-6" data-aos="zoom-in" data-aos-delay="500">
